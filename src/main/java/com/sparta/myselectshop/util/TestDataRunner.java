...
import com.sparta.myselectshop.member.repository.UserRepository;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        // 테스트 User 생성
        User testUser = new User("Robbie", passwordEncoder.encode("1234"), "robbie@sparta.com", UserRole.USER);
